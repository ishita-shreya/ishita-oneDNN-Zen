...
struct jit_uni_i8i8_pooling_fwd_ker_t : public jit_generator_t {
    ...
    Xmm xreg(dim_t idx) const { return Xmm(idx); }
    ...
    Opmask mask(dim_t idx) { return Opmask(6 - idx); }
...
void jit_uni_i8i8_pooling_fwd_ker_t<isa>::compute_c_block() {
    ...
    auto c_block = jpp.c_block;
    auto ur_c = jpp.ur_c;
    auto ur_c_tail = jpp.ur_c_tail;
    auto c_steps = nb_c / ur_c;
    auto c_tail = jpp.c_tail;
