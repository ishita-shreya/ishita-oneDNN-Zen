...
public:
    matmul_amx_blocking_params_t(const brgemm_matmul_conf_t &bgmmc)
        ...
        , nthr_m_(nstl::max<dim_t>(nthr_m, 1))
        , nthr_n_(nstl::max<dim_t>(nthr_n, 1))
        , nthr_k_(nstl::max<dim_t>(nthr_k, 1))
        , nthr_b_(nstl::max<dim_t>(nthr_b, 1))
...
protected:
    ...
    dim_t nthr_m_ {0}, nthr_n_ {0}, nthr_k_ {0}, nthr_b_ {0};
...
private:
    ...
    void set_core_divs(dim_t nthr_b, dim_t nthr_m, dim_t nthr_k, dim_t nthr_n);
