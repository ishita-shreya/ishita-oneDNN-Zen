...
struct brgemm_matmul_t : public primitive_t {
    struct pd_t : public ::dnnl::impl::cpu::matmul::cpu_matmul_pd_t {
        ...
        dim_t get_brg_kernel_idx(bool is_bs_tail, bool do_initialization,
                dim_t m_ker_idx, dim_t n_ker_idx, bool is_K_tail,
...
private:
    ...
    void compute_kernel(const brg_matmul_exec_ctx_t &brgmm_ctx,
            ...
            int ithr, dim_t b_idx, dim_t m_blk_idx, dim_t n_blk_idx, dim_t k_blk_idx,
            bool do_init, dim_t &prev_ker_idx, bool prefetch) const;
    void fill_per_mn_compensation(const brg_matmul_exec_ctx_t &brgmm_ctx,
            int ithr, dim_t m_blk_idx, dim_t n_blk_idx,
            const char *A_data_batch_ptr, const char *B_data_batch_ptr,
